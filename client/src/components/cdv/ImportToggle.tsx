    ...
    <div className={`flex items-center justify-between gap-3 rounded-xl border px-4 py-3 mb-4 transition-colors ${
      ...
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        <div className="min-w-0">
          <Label htmlFor="import-toggle" className="text-[14px] md:text-[15px] font-medium cursor-pointer leading-tight">
            Importar dados do Módulo 1
          </Label>
          <p className="text-[13px] md:text-[14px] text-foreground/50 mt-0.5">
            {enabled
