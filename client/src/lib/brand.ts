...
export const LOGO = {
  // Fundo claro (off-white, branco): texto escuro + quadrado laranja
  dark: "/manus-storage/logo-for-light-bg-v2_e5252f69.png",
  // Fundo escuro (preto, grafite): texto branco + quadrado laranja
  light: "/manus-storage/logo-for-dark-bg-v2_a928c6e3.png",
  ...
  horizontalDark: "/manus-storage/logo-for-light-bg-v2_e5252f69.png",
  horizontalLight: "/manus-storage/logo-for-dark-bg-v2_a928c6e3.png",
