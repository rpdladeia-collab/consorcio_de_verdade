          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center">
            ...
            <div className="w-full md:w-[72%]">
              ...
              <div className="max-w-[560px]">
                ...
                <p className="text-sm md:text-base text-[var(--ink)]/50 mb-8 font-medium max-w-[480px]">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-block bg-[var(--orange)] text-white text-sm font-bold px-8 py-3.5 rounded-full hover:opacity-90 active:scale-95 transition-all shadow-lg shadow-[var(--orange)]/10"
                >
      ...
      <section className="py-10 md:py-14 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <div className="space-y-4 text-sm md:text-base text-[var(--ink)]/70 leading-relaxed max-w-[650px]">
              <p>
      ...
      <section className="py-10 md:py-14 border-t border-[var(--ink)]/5 bg-[var(--paper)]">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mt-12 text-center">
            <p className="text-[10px] md:text-[11px] font-serif italic text-[var(--ink)]/40 uppercase tracking-widest">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full sm:w-auto bg-[var(--orange)] text-white text-sm font-bold px-10 py-3.5 rounded-full hover:opacity-90 active:scale-95 transition-all shadow-lg shadow-[var(--orange)]/10"
            >
              Solicitar análise estratégica
            </a>
            <Link
              href="/simuladores"
              className="w-full sm:w-auto border border-white/20 text-white text-sm font-semibold px-10 py-3.5 rounded-full hover:bg-white hover:text-[var(--ink)] active:scale-95 transition-all"
            >
