      ...
      <div style={{ maxWidth: 1380, margin: "0 auto", padding: 14 }}>
        ...
        <nav style={{ display: "flex", flexWrap: "wrap", gap: 8, margin: "12px 0" }}>
          {(["dados", "quant", "leitura"] as const).map((tab, i) => {
            const labels = ["1. Histórico de Contemplações", "2. Quantitativo das Contemplações", "3. Leitura técnica"];
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8 }}>
                    ...
                    {zonaResult && (
                      <div style={{ ...kpi("orange"), borderLeftColor: trendBorderColor(zonaResult.trend.cls), gridColumn: "1/-1" }}>
                        <div style={{ fontSize: 9.5, textTransform: "uppercase", letterSpacing: ".08em", color: "#b6c0bc", fontWeight: 900 }}>Tendência</div>
              ...
              <div style={{ ...card, padding: 13 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 8, marginTop: 10 }} className="!grid-cols-2 sm:!grid-cols-3 lg:!grid-cols-5">
                  ...
                  <div style={kpi("orange")}>
                    <div style={{ fontSize: 9.5, textTransform: "uppercase", letterSpacing: ".08em", color: "#b6c0bc", fontWeight: 900 }}>Média necessária</div>
                  ...
                  <div style={kpi("orange")}>
                    <div style={{ fontSize: 9.5, textTransform: "uppercase", letterSpacing: ".08em", color: "#b6c0bc", fontWeight: 900 }}>Taxa sorteio geral <HelpBtn tip="Taxa histórica observada: contemplações por sorteio geral divididas pela base geral do recorte selecionado." /></div>
