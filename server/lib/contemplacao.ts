  ...
  const startRow =
    paidMonths > 0
      ...
      : {
          ...
          taBal: schedule.credit * (schedule.adminRate / 100),
          frBal: schedule.credit * (schedule.reserveRate / 100),
  ...
  const row =
    paidMonths > 0
      ...
      : {
          ...
          fcBal: s.credit,
          taBal: s.credit * (s.adminRate / 100),
          frBal: s.credit * (s.reserveRate / 100),
          paidTotal: 0,
